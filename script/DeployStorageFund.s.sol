...
import {FunWithStorage} from "../src/FundWithStorage.sol";
...
contract DeployFunWithStorage is Script {
    ...
    function printFirstArrayElement(address contractAddress) public view {
        ...
        bytes32 secondElementStorageSlot = bytes32(
            uint256(firstElementStorageSlot) + 1
        );
        bytes32 value = vm.load(contractAddress, firstElementStorageSlot);
        bytes32 value2 = vm.load(contractAddress, secondElementStorageSlot);
